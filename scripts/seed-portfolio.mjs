...
const projects = [
  {
    ...
    description: 'Built a Streamlit web app that predicts diabetes risk using machine learning. Designed the interface for users to input health metrics and receive instant, explainable risk predictions.',
    category: 'AI & Data',
  ...
  },
  {
    ...
    description: 'Built a full-stack CV builder with React frontend, Django REST backend, and PostgreSQL. Implemented JWT authentication, live A4 preview, AI writing coach, ATS scoring, job description matching, and one-click PDF export.',
    category: 'Full-Stack',
  ...
  },
  {
    ...
    description: 'Designed and built a fashion e-commerce storefront with clean UI, collection filtering, product pages, cart flow, and admin dashboard.',
    category: 'Frontend',
  ...
  },
  {
    slug: 'decisive-sound',
    name: 'Decisive Sound',
    tagline: 'Premium silent disco headset rental platform',
    description: 'Built a rental platform for wireless silent disco headsets. Implemented product browsing, availability checking, and online booking for weddings, festivals, and corporate events.',
    category: 'Full-Stack',
    technologies: ['Python', 'Django', 'HTML5', 'CSS3', 'JavaScript', 'PostgreSQL'],
    image_url: null,
    screenshots: [],
    problem: 'Event organizers need a simple way to rent silent disco headsets for parties and events.',
    solution: 'Full-stack website with product browsing, availability checking, and online booking for silent disco headset rentals.',
    features: ['Product catalog', 'Availability checking', 'Online booking', 'Responsive design', 'Event information'],
    architecture: 'Full-stack web application with booking system',
    challenges: 'Building a smooth rental booking flow with real-time availability.',
    results: 'Live rental platform serving event organizers.',
