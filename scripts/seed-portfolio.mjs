...
const projects = [
  ...
  },
  {
    ...
    description: 'Website for renting wireless silent disco headsets for weddings, festivals, and corporate events. Browse headset options, check availability, and book online.',
    category: 'Full-Stack',
